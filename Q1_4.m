...
% imfilter using Gaussian 2D kernel, is a linear filter. 
...
% In this case, Gaussian filter alone blur edges and reduce contrast.
% Here we can control the degree of smoothing by ?(larger ? for more intensive smoothing). 
% Whereas using loop, it removes noise while keeping edges relatively sharp.
